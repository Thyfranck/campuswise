...
$(document).ready(function(){
    ...
    $('#new_book').submit(function(e){
        ...
        if(var1 != myRegEx.exec(var1) || (var1 < 5)){
            e.preventDefault();
            $('#book_loan_daily').next('.number_error').html('Must be a number and above 5')
            return false;
        }
        else {
        ...
        if(var2 != myRegEx.exec(var2) || (var2 < 5)){
            e.preventDefault();
            $('#book_loan_weekly').next('.number_error').html('Must be a number and above 5')
            return false;
        }
        else {
        ...
        if(var3 != myRegEx.exec(var3) || (var3 < 5)){
            e.preventDefault();
            $('#book_loan_monthly').next('.number_error').html('Must be a number and above 5')
            return false;
        }
        else {
        ...
        if(var4 != myRegEx.exec(var4) || (var4 < 5)){
            e.preventDefault();
            $('#book_loan_semister').next('.number_error').html('Must be a number and above 5')
            return false;
        }
        else {
