function payment_type(){
    ...
    if(payment_method_type == "Bank Account"){
        ...
        $('#payment_method_paypal').val("");
        $('#payment_method_paypal').parent().parent().hide();
        $('#payment_method_card_number').parent('.field_with_errors').parent().parent().hide();
    }
    ...
    if(payment_method_type == "Paypal"){
        ...
        $('#payment_method_card_number').parent().parent().hide();
        $('#payment_method_card_number').parent('.field_with_errors').parent().parent().hide();
        $('#payment_method_paypal').parent().parent().show();
        $('#payment_method_paypal').parent('.field_with_errors').parent().parent().show();
    }
}
