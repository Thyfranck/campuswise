...
Rails.application.config.sorcery.submodules = [:user_activation, :reset_password, :activity_logging, :brute_force_protection]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.user_activation_mailer = Notification
...
#    user.activation_mailer_disabled = true
    ...
    # Default: `nil`
    #
    user.reset_password_mailer = Notification
